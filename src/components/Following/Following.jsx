      ...
      <div className="w-full grid grid-cols-12 pt-10 gap-5">
        ...
        {followersUser?.map((user) => (
          <div
            ...
            className="group/item w-full h-[200px] flex flex-col overflow-hidden items-center justify-center col-span-2 rounded-2xl p-5 cursor-pointer transition-all duration-300"
            key={user.login}
          >
            <img
              src={user.avatarUrl}
